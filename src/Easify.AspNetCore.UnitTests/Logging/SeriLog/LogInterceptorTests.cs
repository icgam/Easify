...
namespace EasyApi.AspNetCore.UnitTests.Logging.SeriLog
{
    public sealed class LogInterceptorTests : IClassFixture<ServiceCollectionFixture>
    {
        ...
        public void GivenSut_WhenSyncMethodCalledWithoutParameters_AndLogLevelSetToTrace_ThenLogThatMethodHasNoParameters()
        {
            ...
            {
                Assert.Contains("Trace", s);
                Assert.Contains("'Easify.AspNetCore.UnitTests.Helpers.FakeService.Call' is VOID and has no return value.", s);
            });
        ...
        public void GivenSut_WhenSyncMethodWith_Integer_ArgumentsCalled_ThenLogMethodArguments_AndReturnValue()
        {
            ...
            {
                Assert.Contains("Debug", s);
                Assert.Contains("Executing 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResult' ...", s);
            }, s =>
            {
                Assert.Contains("Trace", s);
            ...
            }, s =>
            {
                Assert.Contains("Trace", s);
                Assert.Contains(
                   $"Result for 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResult' is: {value}.", s);
            });
        ...
        public async Task GivenSut_WhenAsyncMethodCalledWithoutParameters_AndLogLevelSetToTrace_ThenLogThatMethodHasNoParameters()
        {
            ...
            {
                Assert.Contains("Trace", s);
                Assert.Contains("'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAsync' is VOID and has no return value.", s);
            });
        ...
        public async Task GivenSut_WhenAsyncMethodWith_Integer_ArgumentsCalled_ThenLogMethodArguments_AndReturnValue()
        {
            ...
            {
                Assert.Contains("Debug", s);
                Assert.Contains("Executing 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResultAsync' ...", s);
            }, s =>
            {
                Assert.Contains("Trace", s);
                Assert.Contains($"Execution parameters: {value}.", s);
            }, s =>
            {
                Assert.Contains("Debug", s);
                Assert.Contains(
                    "'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResultAsync' execution completed.", s);
            }, s =>
            {
                Assert.Contains("Trace", s);
                Assert.Contains(
                   $"Result for 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndReturnResultAsync' is: {value}.", s);
            });
        ...
        public async Task GivenSut_WhenAsyncMethodCalledAndThrows_ThenLogFailedExecution()
        {
            ...
            {
                Assert.Contains("Error", s);
                Assert.Contains("Failed to execute 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowAsync'!" +
                                " 'Easify.AspNetCore.UnitTests.Helpers.FakeException' has been thrown.", s);
            });
        ...
        public async Task GivenSut_WhenAsyncMethodWithArgumentsCalledAndThrows_ThenLogFailedExecution()
        {
            ...
            {
                Assert.Contains("Debug", s);
                Assert.Contains("Executing 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowInsteadOfReturnResultAsync' ...", s);
            }, s =>
            {
                Assert.Contains("Trace", s);
                Assert.Contains($"Execution parameters: {value}.", s);
            ...
            {
                Assert.Contains("Error", s);
                Assert.Contains("Failed to execute 'Easify.AspNetCore.UnitTests.Helpers.FakeService.CallAndThrowInsteadOfReturnResultAsync'!" +
                                " 'Easify.AspNetCore.UnitTests.Helpers.FakeException' has been thrown.", s);
            });
